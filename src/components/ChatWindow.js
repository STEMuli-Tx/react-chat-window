...
class ChatWindow extends Component {
	...
	render() {
		const { isGroup, groupName, groupAvatar } = this.props;
		...
		return (
			<div className={classList.join(' ')}>
				<Header
					...
					teamName={!isGroup ? this.props.agentProfile.teamName : groupName}
					imageUrl={!isGroup ? this.props.agentProfile.imageUrl : ''}
